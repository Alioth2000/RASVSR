...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='../dataset/SVSR400/val/GT', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='results/test_122_90/visualization/SVSR400', help='Path to restored images')
